...
define([
    ...
    var land = React.createClass({displayName: "land",
        ...
        render: function () {
            ...
            var gNode = React.createElement("g", {className: classString, transform: this.state.transform}, 
                                ...
                                this.state.topojsonFeatures.map(function(topojsonFeature, i) {
                                    ...
                                    //if (getDataFromstate[topojsonFeature.properties.PCON12CD]) {
                                        ...
                                        return React.createElement(Path, {key: i, map: name, code: code, d: getPath(topojsonFeature), centroid: centroid, style: cssStyle, onClick: that.handleClick, onMouseOver: that.handleMouseOver, onMouseOut: that.handleMouseOut});
                                    //}
                                }), 
                            
                            React.createElement("text", {x: labelx, y: labely, className: "ns__map-label"}, that.state.label)
                        );
