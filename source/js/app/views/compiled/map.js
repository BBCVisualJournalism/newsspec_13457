            ...
            return (
                React.createElement("svg", {width: this.state.width, height: this.state.height}, 
                        ...
                        lands.map(function(obj, i) {
                            return React.createElement(Land, {name: obj, key: i, responsiveProportion: that.state.responsiveProportion, transform: that.state.resetView})
                        }), 
                    
                    React.createElement("div", null, this.state.scaleProportion)
                )
            );
        }
    });
